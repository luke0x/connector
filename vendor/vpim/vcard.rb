  ...
  class Vcard < DirectoryInfo
    ...
    class Address
      ...
      def encode #:nodoc:
        ...
        # JOYENT: Modified the create() to be passed the array instead of an
        # already formatted String
        Vpim::DirectoryInfo::Field.create( 'ADR', parts, paramshash)
      end
    ...
    class Email < String
      ...
      def Email.decode(field) #:nodoc:
        ...
        # JOYENT CHANGE...commented this out 
        # Ticket 2952
        # if value.length < 1
        #   raise InvalidEncodingError, "EMAIL must have a value"
        # end
    ...
    class Name
      ...
      def encode #:nodoc:
        # JOYENT: Made some modifiations because the encoding was not being done properly
    ...
    def Vcard.decode(card)
      ...
      # JOYENT CHANGES: made some changes in this case statement
      case string
        when /^\xEF\xBB\xBF/
          string = string[3..-1]
        when /^\xFE\xFF/
          string = Iconv.conv('utf-8', 'utf-16', string[2..-1])
        when /^\xFF\xFE/
          string = Iconv.conv('utf-8', 'utf-16le', string[2..-1])
        when /^\x00b/i
          string = Iconv.conv('utf-8', 'utf-16', string)
        when /^b\x00/i
          string = Iconv.conv('utf-8', 'utf-16le', string)
      end
    ...
    class Maker
      ...
      # will be escaped.
      def add_note(note)
        # JOYENT: Encoding will be done in the 'create'
